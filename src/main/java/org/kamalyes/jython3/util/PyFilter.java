...
import org.kamalyes.jython3.util.PythonInterpreter;

/**
 * Enables you to write Jython modules that inherit from
 * <code>javax.servlet.Filter</code>, and to
 * insert them in your servlet container's filter chain, like any Java
 * <code>Filter</code>.
 *
 * <p>
 * Example:
 ...
 *  &lt;filter-class&gt;org.kamalyes.jython3.util.PyFilter&lt;/filter-class&gt;
 *
  ...
  public void init(FilterConfig config) throws ServletException {
    if (config.getServletContext().getAttribute(PyServlet.INIT_ATTR) == null) {
      throw new ServletException("Jython has not been initialized.  Add "
          + "org.kamalyes.jython3.util.PyServletInitializer as a listener to your "
          + "web.xml.");
    }
    this.config = config;
