...
/**
 * This servlet is used to re-serve Jython servlets. It stores bytecode for
 * Jython servlets and
 ...
 *         &lt;servlet-class>org.kamalyes.jython3.util.PyServlet&lt;/servlet-class>
 *         &lt;init-param>
...
public class PyServlet extends HttpServlet {
  ...
  /**
   * PyServlet's initialization can be performed as a ServletContextListener or as
   * a regular
   * servlet, and this is the shared init code. If both initializations are used
   * in a single
