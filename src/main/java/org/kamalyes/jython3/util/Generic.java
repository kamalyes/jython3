...
/**
 * Static methods to make instances of collections with their generic types
 * inferred from what
 * they're being assigned to. The idea is stolen from <code>Sets</code>,
 * <code>Lists</code> and
 * <code>Maps</code> from
...
public class Generic {
   ...
   * ConcurrentHashMap's defaults: it's significantly lower to reduce allocation
   * cost.
   */
  ...
  /**
   * Makes a List with its generic type inferred from whatever it's being assigned
   * to.
   */
  ...
  /**
   * Makes a Map using generic types inferred from whatever this is being assigned
   * to.
   */
  ...
  /**
   * Makes a ConcurrentMap using generic types inferred from whatever this is
   * being
   * assigned to.
   */
  ...
  /**
   * Makes a Set using the generic type inferred from whatever this is being
   * assigned to.
   */
  ...
  /**
   * Makes a Set, ensuring safe concurrent operations, using generic types
   * inferred from
