...
class ReflectedCallData {
  ...
  /**
   * errArg value if the self passed to a call wasn't compatible with the type of
   * the method.
   */
  public static final int UNABLE_TO_CONVERT_SELF = -1;

  /**
   * errArg value if the method has no forms that take the number of arguments
   * given.
   */
  ...
  /**
   * Either {@link #BAD_ARG_COUNT}, {@link #UNABLE_TO_CONVERT_SELF}, or the index
   * of the
