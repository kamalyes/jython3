...
import org.kamalyes.jython3.antlr.NoCloseReaderStream;
import org.kamalyes.jython3.antlr.ParseException;
import org.kamalyes.jython3.antlr.PythonTokenSource;
...
import org.kamalyes.jython3.core.io.TextIOInputStream;
import org.kamalyes.jython3.core.io.UniversalIOWrapper;
import org.kamalyes.jython3.core.util.StringUtil;
import org.kamalyes.jython3.antlr.PythonPartialLexer;
import org.kamalyes.jython3.antlr.PythonPartialParser;
...
/**
 * Facade for the classes in the org.kamalyes.jython3.antlr package.
 */
public class ParserFacade {
   ...
   * distinguish
   * between scripts which return values and those which do not, nor do they make
   * the
   * corresponding distinction between evaluating or executing objects."
   * (SCR.4.2.1)
   */
  ...
  public static mod partialParse(String string,
      ...
      CompilerFlags cflags,
      boolean stdprompt) {
    // TODO: What's the idea of the stdprompt argument?
  ...
  public static class ExpectedEncodingBufferedReader extends BufferedReader {
    ...
    /**
     * The encoding from the source file, or null if none was specified and UTF-8 is
     * being used.
     */
  ...
  private static ExpectedEncodingBufferedReader prepBufReader(InputStream input,
    ...
    if (universalNewlines) {
      ...
      org.kamalyes.jython3.core.io.BufferedReader bufferedIO = new org.kamalyes.jython3.core.io.BufferedReader(rawIO,
          0);
  ...
  private static String readEncoding(InputStream stream) throws IOException {
    ...
    // TODO: reset() can still raise an IOException if a line exceeds our large mark
    // limit
    stream.reset();
