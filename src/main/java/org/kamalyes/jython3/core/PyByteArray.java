...
import org.kamalyes.jython3.core.buffer.BaseBuffer;
import org.kamalyes.jython3.core.buffer.SimpleWritableBuffer;
import org.kamalyes.jython3.core.stringlib.Encoding;
...
/**
 * Implementation of Python <code>bytearray</code> with a Java API that includes
 * equivalents to most
 * of the Python API. These Python equivalents accept a {@link PyObject} as
 * argument, where you
 * might have expected a <code>byte[]</code> or <code>PyByteArray</code>, in
 * order to accommodate
 * the full range of types accepted by the Python equivalent: usually, any
 * <code>PyObject</code>
 * that implements {@link BufferProtocol}, providing a one-dimensional array of
 * bytes, is an
 * acceptable argument. In the documentation, the reader will often see the
 * terms "byte array" or
 * "object viewable as bytes" instead of <code>bytearray</code> when this
 * broader scope is intended.
 * This may relate to parameters, or to the target object itself (in text that
 * applies equally to
...
public class PyByteArray extends BaseBytes implements BufferProtocol {
  ...
  /**
   * Constructs a zero-length Python <code>bytearray</code> of
   * explicitly-specified sub-type
   *
  ...
  /**
   * Constructs a new array filled exactly by a copy of the contents of the
   * source, which is a
  ...
  /**
   * Constructs a new array filled from an iterable of PyObject. The iterable must
   * yield objects
   * convertible to Python bytes (non-negative integers less than 256 or strings
   * of length 1).
   *
   * @param value source of the bytes (and size)
   */
  ...
  /**
   * Constructs a new array by encoding a PyBytes argument to bytes. If the
   * PyBytes is actually
   ...
   *
   * @param arg      primary argument from which value is taken
   * @param encoding name of optional encoding (may be <code>null</code> to select
   *                 the default for
   *                 this installation)
   ...
   * Constructs a new array by encoding a PyBytes argument to bytes. If the
   * PyBytes is actually
   * a PyUnicode, an exception is thrown saying that the encoding must be
  ...
  /**
   * Constructs a <code>bytearray</code> by re-using an array of byte as storage
   * initialised by
   * the client.
   *
   * @param storage pre-initialised with desired value: the caller should not keep
   *                a reference
   */
  ...
  /**
   * Constructs a new <code>bytearray</code> object from an arbitrary Python
   * object according to
   * the same rules as apply in Python to the <code>bytearray()</code>
   * constructor:
   * <ul>
   * <li><code>bytearray()</code> Construct a zero-length
   * <code>bytearray</code>.</li>
   * <li><code>bytearray(int)</code> Construct a zero-initialized
   * <code>bytearray</code> of the
   * given length.</li>
   * <li><code>bytearray(iterable_of_ints)</code> Construct from iterable yielding
   * integers in
   * [0..255]</li>
   * <li><code>bytearray(buffer)</code> Construct by reading from any object
   * implementing
   * {@link BufferProtocol}, including <code>str/bytes</code> or another
   * <code>bytearray</code>.</li>
   * </ul>
   ...
   * {@link #PyByteArray(PyBytes, String, String)}. If the <code>PyBytes</code> is
   * actually a
   * <code>PyUnicode</code>, an encoding must be specified, and using this
   * constructor will throw
   * an exception about that.
   *
   * @param arg primary argument from which value is taken (may be
   *            <code>null</code>)
   * @throws PyException (TypeError) for non-iterable,
   * @throws PyException (ValueError) if iterables do not yield byte [0..255]
   *                     values.
   */
  ...
  /**
   * Hold weakly a reference to a PyBuffer export not yet released, used to
   * prevent untimely
   * resizing.
   */
   ...
   * {@inheritDoc}
   * <p>
   * The {@link PyBuffer} returned from this method is a one-dimensional array of
   * single byte
   * items that allows modification of the object state. The existence of this
   * export <b>prohibits
   * resizing</b> the byte array. This prohibition is not only on the consumer of
   * the view but
  ...
  /**
   * Try to re-use an existing exported buffer, or return <code>null</code> if we
   * can't.
   *
   * @throws PyException (BufferError) if the the flags are incompatible with the
   *                     buffer
   */
  private BaseBuffer getExistingBuffer(int flags) throws PyException {
    ...
    if (export != null) {
      ...
      if (pybuf != null) {
        /*
         * We do not test for pybuf.isReleased() as, if any operation had taken place
         * that
         * invalidated the buffer, resizeCheck() would have set export=null. The
         * exported
         * buffer (navigation, buf member, etc.) remains valid through any operation
         * that
   ...
   * This must be
   * called by the implementation of any append or insert that changes the number
   * of bytes in the
   * array.
   *
   * @throws PyException (BufferError) if there are buffer exports preventing a
   *                     resize
   */
  protected void resizeCheck() throws PyException {
    if (export != null) {
      ...
      if (pybuf != null && !pybuf.isReleased()) {
        ...
        /*
         * Either the reference has expired or all consumers have released it. Either
         * way,
   ...
   * @return a <code>PyByteArray</code> corresponding the the given range of
   *         elements.
   */
  @Override
  ...
  /**
   * Returns a <code>PyByteArray</code> that repeats this sequence the given
   * number of times, as
  ...
  /**
   * Replace the contents of this <code>PyByteArray</code> with the given number
   * of repeats of the
  ...
  /**
   * Sets the indexed element of the <code>bytearray</code> to the given value.
   * This is an
   * extension point called by PySequence in its implementation of
   * {@link #__setitem__} It is
   * guaranteed by PySequence that the index is within the bounds of the array.
   * Any other clients
   * calling <code>pyset(int)</code> must make the same guarantee.
   *
   * @param index index of the element to set.
   * @param value the value to set this element to.
   * @throws PyException (AttributeError) if value cannot be converted to an
   *                     integer
   ...
   * Python
   * <code>int</code>, <code>long</code> and <code>str</code> types of length 1
   * are allowed.
   *
  ...
  /**
   * Sets the given range of elements according to Python slice assignment
   * semantics. If the step
   * size is one, it is a simple slice and the operation is equivalent to deleting
   * that slice,
   * then inserting the value at that position, regarding the value as a sequence
   * (if possible) or
   * as a single element if it is not a sequence. If the step size is not one, but
   * start=stop, it
   * is equivalent to insertion at that point. If the step size is not one, and
   * start!=stop, the
   * slice defines a certain number of elements to be replaced, and the value must
   * be a sequence
   * of exactly that many elements (or convertible to such a sequence).
   * <p>
   * When assigning from a sequence type or iterator, the sequence may contain
   * arbitrary
   * {@link PyObject}s, but acceptable ones are {@link PyInteger}, {@link PyLong}
   * or
   * {@link PyBytes} of length 1. If any one of them proves unsuitable for
   * assignment to a Python
   * <code>bytearray</code> element, an exception is thrown and this
   * <code>bytearray</code> is
   * unchanged.
   *
   * <pre>
  ...
  protected synchronized void setslice(int start, int stop, int step, PyObject value) {
    ...
    /*
     * The actual behaviour depends on the nature (type) of value. It may be any
     * kind of
     * PyObject (but not other kinds of Java Object). The function is implementing
     * assignment to
     * a slice. PEP 3137 declares that the value may be "any type that implements
     * the PEP 3118
     * buffer interface".
     *
     * The following is essentially equivalent to
     * b[start:stop[:step]]=bytearray(value) except
     * we avoid constructing a copy of value if we can easily do so. The logic is
     * the same as
    ...
    if (value instanceof PyBytes) {
      ...
      /*
       * Value behaves as a bytearray, and can be can be inserted without making a
       * copy
      ...
      /*
       * Value supports Jython implementation of PEP 3118, and can be can be inserted
       * without
       * making a copy.
       */
   ...
   * @throws PyException (SliceSizeError) if the value size is inconsistent with
   *                     an extended slice
   */
   ...
   * @param stop  one more than the position of the last element.
   * @param step  the step size.
   * @param value an object supporting the buffer API consistent with the slice
   *              assignment
   * @throws PyException (SliceSizeError) if the value size is inconsistent with
   *                     an extended slice
   */
   ...
   * @param stop  one more than the position of the last element.
   * @param step  the step size.
   * @param value a <code>bytearray</code> (or bytes) object consistent with the
   *              slice assignment
   * @throws PyException (SliceSizeError) if the value size is inconsistent with
   *                     an extended slice
   */
   ...
   * @throws PyException (SliceSizeError) if the iterable size is inconsistent
   *                     with an extended
   *                     slice
   */
  private void setslice(int start, int stop, int step, Iterable<? extends PyObject> iter) {
    /*
     * As we don't know how many elements the iterable represents, we can't adjust
     * the array
     * until after we run the iterator. We use this elastic byte structure to hold
     * the bytes
     * until then.
     */
  ...
  protected synchronized void delslice(int start, int stop, int step, int n) {
    ...
    if (step == 1) {
      ...
      // Close up the gap. Note that for the copy, p was adjusted by the storage
      // offset.
  ...
  /**
   * Convenience method to build (but not throw) a <code>ValueError</code>
   * PyException with the
   * message "attempt to assign {type} of size {valueSize} to extended slice of
   * size {sliceSize}"
   *
   * @param valueType
  ...
  /**
   * Initialise a mutable <code>bytearray</code> object from various arguments.
   * This single
   ...
   * <code>str/bytes</code>, decoded using the system default encoding, and
   * encoded to bytes using
   * the specified encoding.</li>
   * <li><code>bytearray(unicode, encoding [, errors])</code> Construct from a
   * <code>unicode</code> string, encoded to bytes using the specified
   * encoding.</li>
   * </ul>
   * Although effectively a constructor, it is possible to call
   * <code>__init__</code> on a 'used'
  ...
  final synchronized void bytearray___init__(PyObject[] args, String[] kwds) {
     ...
     * Objects/bytearrayobject.c : bytes_init()) but reorganised somewhat to
     * maximise re-use
     * with the implementation of assignment to a slice, which essentially has to
     * construct a
     * bytearray from the right-hand side. Hopefully, it still tries the same things
     * in the same
    ...
    if (encoding != null || errors != null) {
      /*
       * bytearray(string [, encoding [, errors]]) Construct from a text string by
       * encoding it
   ...
   * ===============
   *
   * Extend BaseBytes.Builder so that it can return a PyByteArray and give the
   * superclass a hook
   * for it.
   */
  ...
  /**
   * Equivalent to the standard Python <code>__imul__</code> method, that for a
   * byte array returns
  ...
  /**
   * Equivalent to the standard Python <code>__mul__</code> method, that for a
   * byte array returns
   * a new byte array containing the same thing n times.
   */
  @Override
   ...
   * <code>s[len(s):len(s)] = o</code>. The argument must be a PyInteger, PyLong
   * or string of
   * length 1.
   *
  ...
  /**
   * Implement to the standard Python __contains__ method, which in turn
   * implements the
  ...
  /**
   * Java API equivalent of Python <code>center(width)</code>: return the bytes
   * centered in an
   * array of length <code>width</code>, padded by spaces. A copy of the original
   * byte array is
  ...
  /**
   * Java API equivalent of Python <code>center(width [, fillchar])</code>: return
   * the bytes
   * centered in an array of length <code>width</code>. Padding is done using the
   * specified
   * fillchar (default is a space). A copy of the original byte array is returned
   * if
  ...
  /**
   * Implementation of Python <code>count(sub)</code>. Return the number of
   * non-overlapping
  ...
  /**
   * Implementation of Python <code>count( sub [, start ] )</code>. Return the
   * number of
  ...
  /**
   * Implementation of Python <code>count( sub [, start [, end ]] )</code>. Return
   * the number of
   * non-overlapping occurrences of <code>sub</code> in the range [start, end].
   * Optional arguments
   ...
   *
   * When <code>suffix</code> is of a type that may be treated as an array of
   * bytes, return
   * <code>true</code> if and only if this <code>bytearray</code> ends with the
   * <code>suffix</code>. <code>suffix</code> can also be a tuple of suffixes to
   * look for.
   *
   * @param suffix byte array to match, or object viewable as such, or a tuple of
   *               them
   * @return true if and only if this <code>bytearray</code> ends with the suffix
   *         (or one of them)
   */
   ...
   * <code>suffix</code>. <code>suffix</code> can also be a tuple of suffixes to
   * look for. With
   * optional <code>start</code> (which may be <code>null</code> or
   * <code>Py.None</code>), define
   * the effective <code>bytearray</code> to be the slice <code>[start:]</code> of
   * this
   * <code>bytearray</code>.
   *
   * @param suffix byte array to match, or object viewable as such, or a tuple of
   ...
   * @return true if and only if this[start:] ends with the suffix (or one of
   *         them)
   */
   ...
   * <code>suffix</code>. <code>suffix</code> can also be a tuple of suffixes to
   * look for. With
   * optional <code>start</code> and <code>end</code> (which may be
   * <code>null</code> or
   * <code>Py.None</code>), define the effective <code>bytearray</code> to be the
   * slice
   ...
   * @return true if and only if this[start:end] ends with the suffix (or one of
   *         them)
   */
  ...
  /**
   * Implementation of Python <code>expandtabs()</code>: return a copy of the byte
   * array where all
   * tab characters are replaced by one or more spaces, as
   * {@link #expandtabs(int)} with a tab
  ...
  /**
   * Implementation of Python <code>expandtabs(tabsize)</code>: return a copy of
   * the byte array
   * where all tab characters are replaced by one or more spaces, depending on the
   * current column
   * and the given tab size. The column number is reset to zero after each newline
   * occurring in
   * the array. This treats other non-printing characters or escape sequences as
   * regular
   * characters.
   *
  ...
  /**
   * Append the elements in the argument sequence to the end of the array,
   * equivalent to:
   * <code>s[len(s):len(s)] = o</code>. The argument must be a subclass of
   * {@link BaseBytes} or an
  ...
  final synchronized void bytearray_extend(PyObject o) {
    ...
    // Note this deals with all legitimate PyObject types including the case
    // o==this.
    setslice(size, size, 1, o);
  }

  /**
   * Implementation of Python <code>find(sub)</code>. Return the lowest index in
   * the byte array
   * where byte sequence <code>sub</code> is found. Return -1 if <code>sub</code>
   * is not found.
   *
   * @param sub sequence to find (of a type viewable as a byte sequence)
  ...
  /**
   * Implementation of Python <code>find( sub [, start ] )</code>. Return the
   * lowest index in the
   * byte array where byte sequence <code>sub</code> is found, such that
   * <code>sub</code> is
   * contained in the slice <code>[start:]</code>. Return -1 if <code>sub</code>
   * is not found.
   *
   * @param sub   sequence to find (of a type viewable as a byte sequence)
   * @param start of slice to search
  ...
  /**
   * Implementation of Python <code>find( sub [, start [, end ]] )</code>. Return
   * the lowest index
   * in the byte array where byte sequence <code>sub</code> is found, such that
   * <code>sub</code>
   * is contained in the slice <code>[start:end]</code>. Arguments
   * <code>start</code> and
   * <code>end</code> (which may be <code>null</code> or <code>Py.None</code> )
   * are interpreted as
  ...
  /**
   * Implementation of Python class method <code>bytearray.fromhex(string)</code>,
   * that returns .
   * a new <code>PyByteArray</code> with a value taken from a string of two-digit
   * hexadecimal
  ...
  static PyByteArray bytearray_fromhex(PyType type, PyObject hex) {
    // I think type tells us the actual class but we always return exactly a
    // bytearray
  ...
  /**
   * Implementation of Python <code>index(sub)</code>. Like
   * {@link #find(PyObject)} but raise
   ...
   * {@link #find(PyObject,PyObject)} but raise {@link Py#ValueError} if
   * <code>sub</code> is not
   * found.
   *
   * @param sub   sequence to find (of a type viewable as a byte sequence)
   * @param start of slice to search
   ...
   * {@link #find(PyObject,PyObject,PyObject)} but raise {@link Py#ValueError} if
   * <code>sub</code>
   * is not found.
   *
   * @param sub   sequence to find (of a type viewable as a byte sequence)
  ...
  /**
   * Insert the argument element into the byte array at the specified index. Same
   * as
  ...
  final synchronized void bytearray_insert(PyObject index, PyObject value) {
    // TODO: do something with delegator instead?
  ...
  /**
   * Implementation of Python <code>join(iterable)</code>. Return a
   * <code>bytearray</code> which
   * is the concatenation of the byte arrays in the iterable
   * <code>iterable</code>. The separator
  ...
  /**
   * Java API equivalent of Python <code>ljust(width)</code>: return the bytes
   * left justified in
   * an array of length <code>width</code>, padded by spaces. A copy of the
  ...
  /**
   * Java API equivalent of Python <code>ljust(width [, fillchar])</code>: return
   * the bytes
   * left-justified in an array of length <code>width</code>. Padding is done
   * using the specified
   * fillchar (default is a space). A copy of the original byte array is returned
   * if
   * <code>width</code> is less than <code>this.size()</code>.
  ...
  /**
   * Implementation of Python <code>lstrip()</code>. Return a copy of the byte
   * array with the
   ...
   *
   * Return a copy of the byte array with the leading characters removed. The
   * bytes argument is an
   * object specifying the set of characters to be removed. If <code>null</code>
   * or
   * <code>None</code>, the bytes argument defaults to removing whitespace. The
   * bytes argument is
   ...
   * @return a byte array containing this value stripped of those bytes (at the
   *         left)
   */
  ...
  final synchronized PyByteArray bytearray_lstrip(PyObject bytes) {
    ...
    if (bytes == null || bytes == Py.None) {
      ...
      // Find left bound of the slice that results from the stripping of the specified
      // bytes
   ...
   * <code>del s[s.index(x)]</code>, although x must be convertable to a single
   * byte value. The
   ...
   * <code>PyByteArray</code> with all occurrences of sequence <code>oldB</code>
   * replaced by
   * <code>newB</code>.
   *
  ...
  /**
   * An implementation of Python <code>replace( old, new [, count ] )</code>,
   * returning a
   * <code>PyByteArray</code> with all occurrences of sequence <code>oldB</code>
   * replaced by
   * <code>newB</code>. If the optional argument <code>count</code> is given, only
   * the first
   * <code>count</code> occurrences are replaced.
   *
   * @param oldB     sequence to find
   * @param newB     relacement sequence
   * @param maxcount maximum occurrences are replaced or all if
   *                 <code>maxcount &lt; 0</code>
   * @return result of replacement as a new PyByteArray
   */
  ...
  /**
   * Reverses the contents of the byte array in place. The reverse() methods
   * modify in place for
   * economy of space when reversing a large array. It doesn't return the reversed
   * array to remind
  ...
  /**
   * Implementation of Python <code>rfind(sub)</code>. Return the highest index in
   * the byte array
   * where byte sequence <code>sub</code> is found. Return -1 if <code>sub</code>
   * is not found.
   *
  ...
  /**
   * Implementation of Python <code>rfind( sub [, start ] )</code>. Return the
   * highest index in
   * the byte array where byte sequence <code>sub</code> is found, such that
   * <code>sub</code> is
   * contained in the slice <code>[start:]</code>. Return -1 if <code>sub</code>
   * is not found.
   *
  ...
  /**
   * Implementation of Python <code>rfind( sub [, start [, end ]] )</code>. Return
   * the highest
   * index in the byte array where byte sequence <code>sub</code> is found, such
   * that
  ...
  /**
   * Implementation of Python <code>rindex(sub)</code>. Like
   * {@link #find(PyObject)} but raise
   * {@link Py#ValueError} if <code>sub</code> is not found.
   *
   * @param sub sequence to find (of a type viewable as a byte sequence)
  ...
  /**
   * Java API equivalent of Python <code>rjust(width)</code>: return the bytes
   * right justified in
   * an array of length <code>width</code>, padded by spaces. A copy of the
   * original byte array is
   * returned if width is less than <code>this.size()</code>.
  ...
  /**
   * Java API equivalent of Python <code>rjust(width [, fillchar])</code>: return
   * the bytes
   * right-justified in an array of length <code>width</code>. Padding is done
   * using the specified
   * fillchar (default is a space). A copy of the original byte array is returned
   * if
   * <code>width</code> is less than <code>this.size()</code>.
  ...
  /**
   * Implementation of Python <code>rstrip()</code>. Return a copy of the byte
   * array with the
   ...
   *
   * Return a copy of the byte array with the trailing characters removed. The
   * bytes argument is
   * an object specifying the set of characters to be removed. If
   * <code>null</code> or
   * <code>None</code>, the bytes argument defaults to removing whitespace. The
   * bytes argument is
  ...
  final synchronized PyByteArray bytearray_rstrip(PyObject bytes) {
    ...
    if (bytes == null || bytes == Py.None) {
      ...
      // Find right bound of the slice that results from the stripping of the
      // specified bytes
      ByteSet byteSet = new ByteSet(getViewOrError(bytes));
   ...
   *
   * When <code>prefix</code> is of a type that may be treated as an array of
   * bytes, return
   * <code>true</code> if and only if this <code>bytearray</code> starts with the
   * <code>prefix</code>. <code>prefix</code> can also be a tuple of prefixes to
   * look for.
   *
   * @param prefix byte array to match, or object viewable as such, or a tuple of
   *               them
   * @return true if and only if this <code>bytearray</code> starts with the
   *         prefix (or one of
   *         them)
   */
   ...
   *               them
   * @param start  of slice in this <code>bytearray</code> to match
   * @return true if and only if this[start:] starts with the prefix (or one of
   *         them)
   */
   ...
   * <code>startswith( prefix [, start [, end ]] )</code>.
   *
   * When <code>prefix</code> is of a type that may be treated as an array of
   * bytes, return
   * <code>true</code> if and only if this <code>bytearray</code> starts with the
   ...
   * @param start  of slice in this <code>bytearray</code> to match
   * @param end    of slice in this <code>bytearray</code> to match
   * @return true if and only if this[start:end] starts with the prefix (or one of
   *         them)
   */
  ...
  /**
   * Implementation of Python <code>strip()</code>. Return a copy of the byte
   * array with the
   * leading and trailing whitespace characters removed.
   *
   * @return a byte array containing this value stripped of those bytes (left and
   *         right)
   */
   ...
   *
   * Return a copy of the byte array with the leading and trailing characters
   * removed. The bytes
   * argument is anbyte arrayt specifying the set of characters to be removed. If
   * <code>null</code> or <code>None</code>, the bytes argument defaults to
   * removing whitespace.
   * The bytes argument is not a prefix or suffix; rather, all combinations of its
   * values are
   * stripped.
   *
   * @param bytes treated as a set of bytes defining what values to strip
  ...
  final synchronized PyByteArray bytearray_strip(PyObject bytes) {
    ...
    if (bytes == null || bytes == Py.None) {
      ...
      // Find bounds of the slice that results from the stripping of the specified
      // bytes
      ByteSet byteSet = new ByteSet(getViewOrError(bytes));
      left = lstripIndex(byteSet);
      // If we hit the end that time, no need to work backwards
  ...
  /**
   * An overriding of the standard Java {@link #toString()} method, returning a
   * printable
   * expression of this byte array in the form <code>bytearray(b'hello')</code>,
   * where in the
   * "inner string", any special characters are escaped to their well-known
   * backslash equivalents
   * or a hexadecimal escape. The built-in function <code>repr()</code> is
  ...
  /**
   * An overriding of the {@link PyObject#__str__()} method, returning
   * <code>PyBytes</code>,
   * where in the characters are simply those with a point-codes given in this
   * byte array. The
   ...
   *
   * Return a copy of the byte array where all bytes occurring in the optional
   * argument
   * <code>deletechars</code> are removed, and the remaining bytes have been
   * mapped through the
   * given translation table, which must be of length 256.
   *
   * @param table length 256 translation table (of a type that may be regarded as
   *              a byte array)
   ...
   * given translation table, which must be of length 256.
   *
   * You can use the Python <code>maketrans()</code> helper function in the
   * <code>string</code>
   ...
   *
   * @param table       length 256 translation table (of a type that may be
   *                    regarded as a byte array)
   * @param deletechars object that may be regarded as a byte array, defining
   *                    bytes to delete
   * @return translated byte array
   */
  ...
  /**
   * Return a {@link PyBuffer} representing a translation table, or raise an
   * exception if it is
   * the wrong size. The caller is responsible for calling
   * {@link PyBuffer#release()} on any
   * returned buffer.
   *
  ...
  /**
   * Implementation of Python <code>zfill(width):</code> return the numeric string
   * left filled
   * with zeros in a byte array of length <code>width</code>. A sign prefix is
   * handled correctly
   * if it is in the first byte. A copy of the original is returned if width is
   * less than the
   ...
   * ===============
   *
   * Here we add to the inherited variables defining byte storage, the methods
   * necessary to resize
   * it.
   */

  /**
   * Recommend a length for (but don't allocate) a new storage array, taking into
   * account the
   * current length and the number of bytes now needed. The returned value will
   * always be at least
   * as big as the argument (the length will always be sufficient). If the return
   * value is equal
   * to the present length, it is recommending no reallocation; otherwise, the
   * return is either
   * comfortably bigger than what is currently needed, or significantly smaller
   * than currently
   * allocated. This method embeds our policy for growing or shrinking the
   * allocated array.
   *
  ...
  private final int recLength(int needed) {
    ...
    if (needed > L || needed * 2 < L) {
      ...
      // Amount needed is less than current length, but it doesn't justify
      // reallocation
      return L;
    }
  }
  ...
  /**
   * Allocate fresh storage for at least the requested number of bytes. Spare
   * bytes are allocated
   * evenly at each end of the new storage by choice of a new value for offset. If
   * the size needed
   ...
   * <code>e</code>
   * elements there by moving aside the surrounding elements. The method
   * manipulates the
   * <code>storage</code> array contents, <code>size</code> and
   * <code>offset</code>. It will
   * allocate a new array <code>storage</code> if necessary, or if desirable for
   * efficiency. If
   ...
   * </pre>
   *
   * where the contents of regions of length <code>a</code> and
   * <code>b=size-(a+d)</code> have
   * been preserved, although probably moved, and the gap between them has been
   * adjusted to the
   * requested size.
   * <p>
   ...
   * </pre>
   *
   * The method does not implement the Python repertoire of slice indices, or
   * bound-check the
  ...
  /**
   * Use the existing storage but move two blocks within it to leave a gap of the
   * required size.
   * This is the strategy usually used when the array is still big enough to hold
   * the required new
   * value, but we can't leave either block fixed. If the initial storage looks
   * like this:
   *
   * <pre>
   * |-----f-----|--------a--------|---d---|----------b----------|----------|
   ...
   * </pre>
   *
   * where the regions of length <code>a</code> and <code>b=size-(a+d)</code> have
   * been preserved
   * and the gap between them adjusted to specification. The new offset f' is
   * chosen heuristically
   * by the method to optimise the efficiency of repeated adjustment near either
   * end of the array,
   * e.g. repeated prepend or append operations. The effect on this
   * <code>PyByteArray</code> is
   * that:
   *
   * <pre>
   * this.offset = f'
   ...
   * </pre>
   *
   * Arguments are not checked for validity <b>at all</b>. At call time, a, d, b,
   * and e are
  ...
  private void newStorageAvoided(int a, int d, int b, int e) {
    ...
    // E.g. if insertion was near the end (b small) put most of the new space at the
    // end.
    int f2;
    if (a == b) {
  ...
  /**
   * Allocate new storage and copy two blocks from the current storage to it. If
   * the initial
   ...
   * </pre>
   *
   * Arguments are not checked for validity <b>at all</b>. At call time, a, e and
   * b are
   * non-negative and not all zero.
   *
  ...
  private void newStorage(int L2, int a, int d, int b, int e) {
    ...
    // Choose the new offset f' to make repeated prepend or append operations
    // quicker.
    // E.g. if insertion was near the end (b small) put most of the new space at the
    // end.
    int f2;
  ...
  /**
   * Prepare to insert <code>e</code> elements at the end of the storage currently
   * in use. If
   * necessary. existing elements will be moved. The method manipulates the
   * <code>storage</code>
   * array contents, <code>size</code> and <code>offset</code>. It will allocate a
   * new array
   * <code>storage</code> if necessary for growth. If the initial storage looks
   * like this:
   *
   * <pre>
   *               |-          s          -|
   ...
   * </pre>
   *
   * or like this if e was too big for the gap, but not enough to provoke
   * reallocation:
   *
   * <pre>
   * |-                    s'                 -|
   ...
   * </pre>
   *
   * where the contents of region <code>a</code> have been preserved, although
   * possbly moved, and
   * the gap at the end has the requested size. this method never shrinks the
   * total storage. The
   ...
   * sizes given, since code leading up to the call has done that.
   *
   * @param e size of hole to open (will be x[a, a+e-1]) where a = size before
   *          call
   */
  private void storageExtend(int e) {

    // XXX Do a better job here or where called of checking offset+size+e <=
    // storage.length
  ...
  /**
   * Delete <code>d</code> elements at index <code>a</code> by moving together the
   * surrounding
   * elements. The method manipulates the <code>storage</code> array,
   * <code>size</code> and
   * <code>offset</code>, and will allocate a new storage array if necessary, or
   * if the deletion
   ...
   * where the regions of length <code>a</code> and <code>b=size-(a+d)</code> have
   * been preserved
   * and the gap between them eliminated. The effect on this
   * <code>PyByteArray</code> is that:
   *
   * <pre>
   * this.offset = f'
   * this.size = s' = a+b
   * </pre>
   *
   * The method does not implement the Python repertoire of slice indices but
   * avoids indexing
   * outside the <code>bytearray</code> by silently adjusting a to be within it.
   * Negative d is
