...
public class PyMethod extends PyObject implements InvocationHandler, Traverseproc {
  ...
  /**
   * The function (or other callable) implementing a method, also available via
   * im_func
   */
  ...
  /**
   * The instance to which a method is bound; None for unbound methods also
   * available via im_self
   */
  ...
  private PyObject checkSelf(PyObject arg, PyObject[] args) {
    ...
    if (self == null) {
      ...
      if (!ok) {
        // TODO: Need equiv. of PyEval_GetFuncDesc instead of
        // hardcoding "()"
  ...
  // public void setDoc() {
  // throw Py.AttributeError("attribute '__doc__' of 'instancemethod' objects is
  // not writable");
  // }
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    // Handle invocation when invoked through Proxy (as coerced to single method
    // interface)
    if (method.getDeclaringClass() == Object.class) {
