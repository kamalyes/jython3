 ...
 * in Jython without it. </b>Still we took care to have all core classes
 * implement
 ...
 * potentially own direct references to other {@code PyObject}s. Note that
 * indirect
 * references via non-PyObjects should also be treated as "direct" (c.f.
 * tracefunc in {@link org.kamalyes.jython3.core.PyFrame}).
 * {@code PyObject}s that don't own references to other {@code PyObject}s under
 * any
 * condition and neither inherit such references from a superclass are strictly
 * recommended to be annotated {@link org.kamalyes.jython3.core.Untraversable}.
 * </p>
 * <p>
 * Jython's traverse mechanism serves debugging purposes to ease finding memory
 * leaks and compare gc behavior with CPython. While it is of course not
 * required
 ...
 * gc behaviors. See also {@link org.kamalyes.jython3.modules.gc} for more
 * details on this.
 * </p>
 * <p>
 ...
 * traversal in some edge-cases (which might also conflict with security
 * managers).
 * </p>
 * <p>
 * Note that the slots-array and - if existent - the user-dict of
 * {@code fooDerived}
 * classes is traversed by
 * {@link org.kamalyes.jython3.core.TraverseProcDerived}.
 * The gc-module takes care of exploiting both traverse methods in its static
 * traverse
 * method. So for manual traversion one should always use
 * {@link org.kamalyes.jython3.modules.gc#traverse(PyObject, Visitproc, Object)}
 * rather
 * than directly calling methods in this interface.
 * </p>
 * <p>
 * Also note that {@link org.kamalyes.jython3.core.PyObject#objtype} is not
 * subject to
 ...
 * {@link org.kamalyes.jython3.core.PyObject#objtype} is actually
 ...
 * {@link org.kamalyes.jython3.core.Visitproc}. If {@code Object}s or
 * {@code interface}-types are
 ...
 * {@link org.kamalyes.jython3.core.PyException} and
 * {@link com.ziclix.python.sql.Fetch}.
 ...
 * {@link org.kamalyes.jython3.modules.gc#traverseByReflection(Object, Visitproc, Object)}.
 * This is for instance used in {@link org.kamalyes.jython3.core.PyArray}.
 * </p>
 * <p>
 * <br>
 * <b>Examples</b><br>
 ...
 * lines and a comment "Traverseproc implementation".<br>
 * <br>
 * Let's start with classes that don't hold references to {@code PyObject}s.
 * If the class extends some other class that implements {@code Traverseproc},
 * nothing
 * special needs to be done. For instance, we have this situation in
 * {@link org.kamalyes.jython3.core.PySet}. It extends
 * {@link org.kamalyes.jython3.core.BaseSet},
 * which in turn implements {@code Traverseproc}:<br>
 * <br>
 * 
 * <pre>
 ...
 * {@link org.kamalyes.jython3.core.PyInteger} is
 * an example for this:<br>
 * <br>
 * 
 * <pre>
 ...
 * </pre>
 * 
 * If there are simply some {@code PyObject}(-subclass), non-static fields in
 * the class,
 * let it implement {@link org.kamalyes.jython3.core.Traverseproc}.
 * Write
 * {@link org.kamalyes.jython3.core.Traverseproc#traverse(Visitproc, Object)} by
 * just visiting the fields one by one. Check each to be non-{@code null}
 * previously
 * unless the field cannot be {@code null} for some good reason. If
 * {@link org.kamalyes.jython3.core.Visitproc#visit(PyObject, Object)} returns
 * non-zero,
 * return the result immediately (i.e. abort the traverse process).
 * The following example is taken from
 * {@link org.kamalyes.jython3.core.PyMethod}:<br>
 * <br>
 * 
 * <pre>
 ...
 * 
 * Implement
 * {@link org.kamalyes.jython3.core.Traverseproc#refersDirectlyTo(PyObject)}
 ...
 * non-zero.
 * The following example is taken from
 * {@link org.kamalyes.jython3.core.BaseSet}:<br>
 * <br>
 * 
 * <pre>
 *  /{@literal *} Traverseproc implementation {@literal *}/
 ...
 * {@link org.kamalyes.jython3.core.PyJavaType}):<br>
 * <br>
 * 
 * <pre>
 *  /{@literal *} Traverseproc implementation {@literal *}/
 ...
 * In contrast to that,
 * {@link org.kamalyes.jython3.core.Traverseproc#refersDirectlyTo(PyObject)}
 * should call its parent-method as late as possible, because that method might
 * throw an
 * {@code UnsupportedOperationException}. By calling it in the end, we have the
 * chance
 * to fail- or succeed fast before a potential exception occurs:<br>
 * <br>
 * 
 * <pre>
 *  {@literal @}Override
 ...
 * </pre>
 * 
 * While reflection-based traversal should be avoided if possible, it can be
 * used to
 * traverse fields that might contain references to {@code PyObject}s, but
 * cannot be
 * inferred at compile-time.
 * {@link org.kamalyes.jython3.modules.gc#canLinkToPyObject(Class, boolean)} can
 * help to safe
 * some performance by failing fast if type-info already rules out the
 * possibility
 * of the field holding {@code PyObject}-references.
 * This technique is for instance used to traverse the content of
 * {@link org.kamalyes.jython3.core.PyArray}:<br>
 * <br>
 * 
 * <pre>
 *  /{@literal *} Traverseproc implementation {@literal *}/
 ...
 * </pre>
 * 
 * {@link org.kamalyes.jython3.modules.gc#canLinkToPyObject(Class, boolean)}
 * also
 * offers a way to let
 * {@link org.kamalyes.jython3.core.Traverseproc#refersDirectlyTo(PyObject)}
 * fail fast by type-information:<br>
 * <br>
 * 
 * <pre>
 *  {@literal @}Override
 ...
 * <p>
 * <br>
 * <b>List of {@code PyObject}-subclasses</b><br>
 * <br>
 * We conclude with a list of {@code PyObject} subclasses in Jython, excluding
 * derived classes.<br>
 * {@code PyObject}-subclasses in Jython checked for need of
 * {@code Traverseproc}:<br>
 * <br>
 * <br>
 * org.kamalyes.jython3.core:<br>
 * __builtin__:<br>
 ...
 * MapClassMethod - no refs, untraversable (extends
 * PyBuiltinClassMethodNarrow)<br>
 * JavaProxySet:<br>
 ...
 * PySequence - no refs, abstract class (default Traverseproc
 * implementation)<br>
 ...
 * <br>
 * org.kamalyes.jython3.modules._collections:<br>
 ...
 * <br>
 * org.kamalyes.jython3.modules._jythonlib:<br>
 * dict_builder - Traverseproc<br>
 * <br>
 * org.kamalyes.jython3.modules._threading:<br>
 * Condition - Traverseproc<br>
 * Lock - no refs, untraversable<br>
 * <br>
 * org.kamalyes.jython3.modules._weakref:<br>
 ...
 * <br>
 * org.kamalyes.jython3.modules.bz2:<br>
 ...
 * <br>
 * org.kamalyes.jython3.modules.itertools:<br>
 ...
 * <br>
 * org.kamalyes.jython3.modules.jffi:<br>
 * ArrayCData - Traverseproc (with call to super; maybe check referenceMemory
 * field whether it extends PyObject)<br>
 * ArrayIter - no refs, extends PyIterator<br>
 * BasePointer - no refs, abstract class<br>
 * ByReference - no refs, untraversable (maybe check memory field whether it
 * extends PyObject)<br>
 * CData - Traverseproc (maybe check referenceMemory field whether it extends
 * PyObject)<br>
 ...
 * <br>
 * org.kamalyes.jython3.modules.posix:<br>
 * PosixModule:<br>
 ...
 * PyStatement - Traverseproc (because Object sql could be a PyObject or
 * Traverseproc)<br>
 ...
 * <br>
 * org.kamalyes.jython3.antlr.ast:<br>
 ...
 * <br>
 * org.kamalyes.jython3.antlr.base:<br>
 ...
 * <br>
 * org.kamalyes.jython3.antlr.op:<br>
 ...
 * @see org.kamalyes.jython3.core.Visitproc
 * @see org.kamalyes.jython3.modules.gc#traverse(PyObject, Visitproc, Object)
 * @see org.kamalyes.jython3.modules.gc#traverseByReflection(Object, Visitproc,
 *      Object)
 * @see org.kamalyes.jython3.modules.gc#canLinkToPyObject(Class, boolean)
 */
