...
public class PyFrame extends PyObject implements Traverseproc {
  ...
  /**
   * temporary store for the thrown exception, if the generator survives, it means
  ...
  private static final String FREEVAR_ERROR_MSG = "free variable '%.200s' referenced before assignment";
  ...
  public PyObject getTrace() {
    return tracefunc instanceof PythonTraceFunction ? ((PythonTraceFunction) tracefunc).tracefunc : Py.None;
  }
  ...
  public PyObject getf_locals() {
    // TODO: This could be deprecated, grab f_locals directly
  ...
  public boolean refersDirectlyTo(PyObject ob) throws UnsupportedOperationException {
    ...
    return generatorInput instanceof Traverseproc ? ((Traverseproc) generatorInput).refersDirectlyTo(ob) : false;
  }
}
