...
public class JavaImportHelper {
   ...
   * <p>
   * This is handy in cases where the package scan cannot run, or when the initial
   * classpath does not contain all .jar
   * files (such as in J2EE containers).
   * <p>
   * There is some self-healing in the sense that a correct, explicit import of a
   * java class will succeed even if
   * sys.modules already contains a Py.None entry for the corresponding java
   * package.
   * 
   * @param packageName The dotted name of the java package
   * @param fromlist    A tuple with the from names to import. Can be null or
   *                    empty.
   * 
   * @return <code>true</code> if a java package was doubtlessly identified and
   ...
   * <p>
   * May return <code>false</code> even if the given package name is a valid java
   * package !
   * 
   * @param packageName
   * 
   * @return <code>true</code> if the package with the given name is already
   *         loaded by the VM, <code>false</code>
   *         otherwise.
   */
   ...
   * <p>
   * Do some sanity checks: filter out '*' and empty tuples, as well as non
   * tuples.
   * 
   * @param fromlist
   ...
   * 
   * @param packageName
   * @param packages    A Map containing all packages actually known to the VM.
   *                    Such a Map can be obtained using
   ...
   * <p>
   * All parent packages appear as single entries like python modules, e.g.
   * <code>java</code>,
   ...
   * 
   * @return <code>true</code> if something was really added, <code>false</code>
   *         otherwise
   */
