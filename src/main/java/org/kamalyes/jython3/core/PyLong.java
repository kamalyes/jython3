...
public class PyLong extends PyObject {
   ...
   * subtype
   * instance and initializes it from the regular long. The regular long is then
   * thrown away.
   */
  ...
  /**
   * Coercion logic for long. Implemented as a final method to avoid invocation of
   * virtual methods
  ...
  public static PyObject _pow(BigInteger value, BigInteger y, PyObject modulo, PyObject left,
    ...
    if (modulo == null) {
      ...
      if (z.compareTo(BigInteger.valueOf(0)) <= 0) {
        ...
        // TODO: 1.1 no longer supported so review this.
