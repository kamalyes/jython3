...
import org.kamalyes.jython3.core.BaseBytes;
...
public class StringUtil {
  ...
  /**
   * Encodes this String into a sequence of bytes. Each byte contains the
   * low-order bits of its
   * corresponding char.
   *
  ...
  /**
   * Return a new String with chars corresponding to buf, which is a byte-oriented
   * buffer obtained
   * through the buffer API. It depends on the implementation of
   * {@link PyBuffer#toString()}
  ...
  /**
   * Decapitalize a String if it begins with a capital letter, e.g.: FooBar ->
   * fooBar
   *
