 ...
 * can be attached to arbitrary {@link org.kamalyes.jython3.core.PyObject}s.
 ...
 * to attach
 * {@link org.kamalyes.jython3.modules._weakref.GlobalRef}-objects in the
 * {@link org.kamalyes.jython3.modules._weakref.WeakrefModule}.
 * </p>
 * <p>
 ...
 * {@link org.kamalyes.jython3.core.finalization.FinalizeTrigger}s and
 * {@code javaProxy} are included in the list; {@code javaProxy} always
 * on top so there is no speed-regression,
 * {@link org.kamalyes.jython3.core.finalization.FinalizeTrigger} on bottom,
...
public abstract class JyAttribute implements Serializable {
   ...
   * weakrefs (i.e.
   * {@link org.kamalyes.jython3.modules._weakref.AbstractReference})
  ...
  /**
   * Allows the id of a {@link org.kamalyes.jython3.core.PyObject} to persist
  ...
  /**
   * Used by {@link org.kamalyes.jython3.modules.gc}-module to mark cyclic
  ...
  /**
   * Used by {@link org.kamalyes.jython3.modules.gc}-module to mark
  ...
  /**
   * Checks whether the given {@link org.kamalyes.jython3.core.PyObject}
   ...
   * If no corresponding attribute exists yet, one is created. If {@value ==
   * null},
    ...
    if (value == null) {
      ...
      if (ob.attributes == null) {
        if (attr_type == JyAttribute.JAVA_PROXY_ATTR) {
          ...
          ob.attributes = attr_type < 0 ? new AttributeLink(attr_type, value)
        ...
        if (attr_type == JyAttribute.JAVA_PROXY_ATTR) {
          ...
          ((JyAttribute) ob.attributes).setNext(
              attr_type < 0 ? new AttributeLink(attr_type, value) : new TransientAttributeLink(attr_type, value));
        }
      } else {
        JyAttribute att = (JyAttribute) ob.attributes;
        if (att.attr_type > attr_type) {
          JyAttribute newAtt = attr_type < 0 ? new AttributeLink(attr_type, value)
              : new TransientAttributeLink(attr_type, value);
          newAtt.setNext(att);
