 ...
 *
 * Proxy classes are created whenever a python class inherits from a java class.
 * Instances of such a
...
public interface PyProxy {
  ...
  /**
   * Associate a PyObject with this proxy instance. This is done during
   * construction and
  ...
  /**
   * Associate an system state with this proxy instance. This is done during
   * construction and
   * initialization of the proxy instance.
   */
  ...
  /**
   * Initialize the proxy instance. If the proxy is not initialized, this will
   * call the python
   * constructor with <code>args</code>.
   * <p>
   * In some situations is it necessary to call the __initProxy__ method from the
   * java superclass
   * ctor before the ctor makes call to methods that is overridden in python.
   * <p>
   * In most situation the __initProxy__ is called automatically by the jython
   * runtime.
   */
