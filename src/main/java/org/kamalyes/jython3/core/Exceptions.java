...
public class Exceptions {
  ...
  public static PyObject StopIteration() {
    ...
    // __dict__.__setitem__("__repr__", bindStaticJavaMethod("__repr__",
    // "StopIteration__repr__"));
    return __dict__;
  }
  ...
  // public static PyUnicode StopIteration__repr__(PyObject self, PyObject[] args,
  // String[] kwargs) {
  ...
  public static PyObject OSError__reduce__(PyObject self, PyObject[] args,
    ...
    // self->args is only the first two real arguments if there was a file name
    // given
    // to OSError
