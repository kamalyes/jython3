...
/**
 * An abstract helper class useful when implementing an iterator object. This
 * implementation supply
 * a correct __iter__() and a next() method based on the __next__()
 * implementation. The
 ...
 * in stopException so
 * the correct exception can be thrown to preserve the line numbers in the
 * traceback.
 */
...
public abstract class PyIterator extends PyObject implements Iterable<Object>, Traverseproc {
   ...
   *
   * Note that exposed derivable subclasses of PyIterator should override next to
   * call
