...
public class PyFunction extends PyObject implements InvocationHandler, Traverseproc {
  ...
  public PyFunction(PyObject globals, PyObject[] defaults, PyDictionary kw_defaults, PyDictionary annotations,
  ...
  public PyFunction(PyObject globals, PyObject[] defaults, PyDictionary kw_defaults, PyCode code, PyObject doc,
    ...
    // TODO: workaround the compiler passing Py.EmptyObjects
  ...
  static final PyObject function___new__(PyNewWrapper new_, boolean init, PyType subtype,
    ...
    PyFunction function = new PyFunction(globals,
        defaults == Py.None
            ? null
            : ((PyTuple) defaults).getArray(),
        kw_defaults == Py.None
            ? null
            : (PyDictionary) kw_defaults,
        tcode, null,
        closure == Py.None
            ? null
            : ((PyTuple) closure).getArray());
    if (name != Py.None) {
