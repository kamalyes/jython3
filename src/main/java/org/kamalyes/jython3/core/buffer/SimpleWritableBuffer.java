...
public class SimpleWritableBuffer extends SimpleBuffer {
  ...
  /**
   * Provide an instance of <code>SimpleWritableBuffer</code>, on a slice of a
   * byte array, meeting
  ...
  /**
   * Provide an instance of <code>SimpleWritableBuffer</code>, on the entirety of
   * a byte array,
   * meeting the consumer's expectations as expressed in the <code>flags</code>
   * argument, which is
   ...
   * {@inheritDoc}
   * <p>
   * <code>SimpleWritableBuffer</code> provides an implementation ensuring the
   * returned slice is
   * writable.
   */
  @Override
  ...
  /**
   * A <code>SimpleWritableBuffer.SimpleView</code> represents a contiguous
