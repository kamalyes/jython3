package org.kamalyes.jython3.core.adapter;
...
import org.kamalyes.jython3.core.PyProxy;
import org.kamalyes.jython3.core.PyType;
import org.kamalyes.jython3.core.PyUnicode;

/**
 * Implements the algorithm originally used in {@link Py#java2py} to adapt
 * objects.
 *
 * Pre-class adapters are added to handle instances of PyObject, PyProxy and
 * null values. Class
 * adapters are added to handle builtin Java classes: String, Integer, Float,
 * Double, Byte, Long,
 * Short, Character, Class and Boolean. An adapter is added to the post-class
 * adapters to handle
 * wrapping arrays properly. Finally, if all of the added adapters can handle an
 * object, it's
...
public class ClassicPyObjectAdapter extends ExtensiblePyObjectAdapter {
  ...
  /**
   * Always returns true as we just return new PyJavaInstance(o) if the adapters
   * added to the
