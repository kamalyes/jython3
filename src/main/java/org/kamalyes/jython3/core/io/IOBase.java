 ...
 *
 * IOBase and its descendents in org.kamalyes.jython3.core.io are based off
 * Python 3's new io module (PEP
 * 3116).
 *
 * This does not define read(), readinto() and write(), nor readline() and
 * friends, since their
...
public abstract class IOBase {
  ...
  /**
   * Seek to byte offset pos relative to position indicated by whence: 0 Start of
   * stream (the
   * default). pos should be >= 0; 1 Current position - whence may be negative; 2
   * End of stream -
   ...
   *
   * This must be idempotent. It should also set a flag for the 'closed' property
   * (see below) to
   * test.
   */
  public void close() {
