 ...
 */
@Untraversable
@ExposedType(name = "range", base = PyObject.class, isBaseType = false, doc = BuiltinDocs.range_doc)
public class PyRange extends PySequence {
  ...
  public String toString() {
    ...
    if (lstop > PySystemState.maxint) {
      lstop = PySystemState.maxint;
    } else if (lstop < PySystemState.minint) {
