...
import org.kamalyes.jython3.compiler.APIVersion;
import org.kamalyes.jython3.compiler.AdapterMaker;
import org.kamalyes.jython3.compiler.CustomMaker;
import org.kamalyes.jython3.compiler.JavaMaker;
...
class MakeProxies {
  ...
  private static final String proxyPrefix = "org.kamalyes.jython3.proxies.";
  ...
  public static synchronized Class<?> makeProxy(Class<?> superclass,
    ...
    // Grab the proxy maker from the class if it exists, and if it does, use the
    // proxy class
    // name from the maker
