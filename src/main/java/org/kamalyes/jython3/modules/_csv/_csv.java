 ...
 *
 * Provides the low-level underpinnings of a CSV reading/writing module. Users
 * should not
...
public class _csv {
  ...
  // TODO: should be per PySystemState
  /** Dialect registry. */
  ...
  private static ArgParser parseArgs(String funcName, PyObject[] args, String[] keywords) {
    // TODO:: _weakref.ReferenceType has the same code
