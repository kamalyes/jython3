...
public class PyRandom extends PyObject {
  ...
  /**
   * Sets the seed of the internal number generated to seed. If seed is a
   * PyInteger or PyLong, it
  ...
  /**
   * Generate a random number on [0,1) with 53-bit resolution. Implementation
   * lifted from
   * _randommodule.c:random_random(), but we use &gt;&gt;&gt; instead of &gt;&gt;
   * to avoid sign
   * problems.
   */
  @ExposedMethod
