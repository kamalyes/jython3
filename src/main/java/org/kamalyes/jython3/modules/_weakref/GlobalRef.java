...
public class GlobalRef extends WeakReference<PyObject> {
  ...
  /**
   * This reference's hashCode: The {@code System.identityHashCode} of the
   * referent.
  ...
  /**
   * The public hashCode for the Python AbstractReference wrapper. Derived from
   * the
   * referent's hashCode.
   */
   ...
   *
   * @param object a {@link org.kamalyes.jython3.core.PyObject} to reference
   ...
   * {@link org.kamalyes.jython3.modules._weakref.AbstractReference}s. The
   * current {@code GlobalRef} is disbanded.
   * If the given {@link org.kamalyes.jython3.core.PyObject} is not the former
   ...
   * {@link org.kamalyes.jython3.core.PyObject}.
   *
   * @param object a {@link org.kamalyes.jython3.core.PyObject}
   * @return a {@link org.kamalyes.jython3.core.PyList} of references. May be
   *         empty.
   */
