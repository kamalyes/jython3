...
import org.kamalyes.jython3.core.PyIgnoreMethodTag;
...
class OperatorFunctions extends PyBuiltinFunctionSet {
  ...
  public PyObject __call__(PyObject arg1) {
    switch (index) {
      ...
      case 14:
        return arg1.__pos__();
      case 15:
        return Py.newBoolean(arg1.__bool__());
      case 16:
      ...
      case 53:
        return Py.newLong(arg1.__len__());
      default:
  ...
  public PyObject __call__(PyObject arg1, PyObject arg2, PyObject arg3) {
    switch (index) {
      case 22:
        arg1.__delitem__(new PySlice(arg2.__index__(), arg3.__index__(), Py.None));
        return Py.None;
      case 24:
        return arg1.__getitem__(new PySlice(arg2.__index__(), arg3.__index__(), Py.None));
      case 25:
...
public class operator extends PyObject implements ClassDictInit {
  ...
  static class PyAttrGetter extends PyObject implements Traverseproc {
    ...
    private PyObject getattr(PyObject obj, PyObject name) {
      // TODO: We should probably have a PyObject.__getattr__(PyObject) that does
