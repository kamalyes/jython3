...
import static org.kamalyes.jython3.modules.jffi.CodegenUtils.*;
...
final class AsmClassBuilder {
  ...
  public static ClassVisitor newCheckClassAdapter(ClassVisitor cv) {
    try {
      Class<? extends ClassVisitor> tmvClass = Class.forName("org.objectweb.asm.util.CheckClassAdapter")
  ...
  public static final ClassVisitor newTraceClassVisitor(PrintWriter out) {
    try {
      ...
      Class<? extends ClassVisitor> tmvClass = Class.forName("org.objectweb.asm.util.TraceClassVisitor")
          .asSubclass(ClassVisitor.class);
