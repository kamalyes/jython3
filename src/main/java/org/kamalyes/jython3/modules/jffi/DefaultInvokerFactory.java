...
class DefaultInvokerFactory {
  ...
  final Invoker createInvoker(com.kenai.jffi.Function function, PyObject returnType,
  ...
  final Invoker createInvoker(com.kenai.jffi.Function function, NativeType returnType,
      ParameterMarshaller[] marshallers) {
    switch (returnType) {
      case VOID:
