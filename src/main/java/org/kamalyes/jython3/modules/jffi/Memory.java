 ...
 * <p>
 * This abstracts read/write operations to either a native memory area, or a
 * java
 * ByteBuffer.
 * </p>
 */
public interface Memory {
   ...
   * 
   * @param offset The offset within the memory area to read the value.
   * @return A <tt>DirectMemory</tt> accessor that can be used to access the
   *         memory
  ...
  /**
   * Writes a native long integer value to the memory area at the specified
   * offset.
   * 
   * @param offset The offset within the memory area to write the value.
   ...
   * @param len    The number of bytes of the byte array to write to the memory
   *               area. (not including zero byte)
   */
