 ...
 * <P>
 * <dl>
 * <dt><b><tt>pack</tt></b> (<var>fmt, v1, v2, ...</var>)
 * <dd>
 ...
 * <P>
 * <dl>
 * <dt><b><tt>unpack</tt>></b> (<var>fmt, string</var>)
 * <dd>
 ...
 * <P>
 * <dl>
 * <dt><b><tt>calcsize</tt></b> (<var>fmt</var>)
 * <dd>
 ...
 * <td>integer</td>
 * <tr>
 * <td align=center><samp>size</samp></td>
 * <td><tt>long</tt></td>
 * <td>integer</td>
 * <tr>
 * <td align=center><samp>L</samp></td>
 * <td><tt>unsigned long</tt></td>
 * <td>integer</td>
 * <tr>
 * <td align=center><samp>f</samp></td>
 * <td><tt>float</tt></td>
 * <td>float</td>
 * <tr>
 * <td align=center><samp>d</samp></td>
 * <td><tt>double</tt></td>
 * <td>float</td>
 * <tr>
...
public class struct implements ClassDictInit {
  ...
  static class ByteStream {
    ...
    ByteStream(String s, int offset) {
      ...
      // System.out.println("s.length()=" + s.length() + ",offset=" + offset +
  ...
  static class PointerFormatDef extends FormatDef {
    ...
    void pack(ByteStream buf, PyObject value) {
      // throw Py.NotImplementedError("Pointer packing/unpacking not implemented in
      // Jython");
      int v = get_int(value);
