...
/**
 * This module is a nearly exact line by line port of _json.c to Java. Names and
 * comments are retained
 * to make it easy to follow, but classes and methods are modified to following
...
public class _json implements ClassDictInit {
  ...
  private static synchronized PyObject get_errmsg_fn() {
    if (errmsg_fn == null) {
      PyObject json = org.kamalyes.jython3.core.__builtin__.__import__("json");
      if (json != null) {
