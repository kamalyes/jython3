...
public class Scanner extends PyObject implements Traverseproc {
  ...
  public PyTuple _parse_object(PyBytes pystr, int idx) { // }, Py_ssize_t *next_idx_ptr) {
     ...
     * 
     * Returns a new PyTuple of a PyObject (usually a dict, but object_hook can
     * change that)
  ...
  public PyTuple _scan_once(PyBytes pystr, int idx) {
    ...
    switch (str.getInt(idx)) {
      ...
      case 'n':
        /* null */
        if ((idx + 3 < length) && str.getInt(idx + 1) == 'u' && str.getInt(idx + 2) == 'l'
            && str.getInt(idx + 3) == 'l') {
      ...
      case 't':
        /* true */
        if ((idx + 3 < length) && str.getInt(idx + 1) == 'r' && str.getInt(idx + 2) == 'u'
            && str.getInt(idx + 3) == 'e') {
      ...
      case 'f':
        /* false */
        if ((idx + 4 < length) && str.getInt(idx + 1) == 'a' && str.getInt(idx + 2) == 'l' && str.getInt(idx + 3) == 's'
            && str.getInt(idx + 4) == 'e') {
      ...
      case 'I':
        /* Infinity */
        if ((idx + 7 < length) && str.getInt(idx + 1) == 'n' && str.getInt(idx + 2) == 'f' && str.getInt(idx + 3) == 'i'
            && str.getInt(idx + 4) == 'n' && str.getInt(idx + 5) == 'i' && str.getInt(idx + 6) == 't'
            && str.getInt(idx + 7) == 'y') {
      ...
      case '-':
        /* -Infinity */
        if ((idx + 8 < length) && str.getInt(idx + 1) == 'I' && str.getInt(idx + 2) == 'n' && str.getInt(idx + 3) == 'f'
            && str.getInt(idx + 4) == 'i' && str.getInt(idx + 5) == 'n' && str.getInt(idx + 6) == 'i'
            && str.getInt(idx + 7) == 't' && str.getInt(idx + 8) == 'y') {
  ...
  public PyTuple _match_number(PyBytes pystr, int start) {
    ...
    if (str.getInt(idx) >= '1' && str.getInt(idx) <= '9') {
      idx++;
      while (idx <= end_idx && str.getInt(idx) >= '0' && str.getInt(idx) <= '9')
        idx++;
    }
    ...
    if (idx < end_idx && (str.getInt(idx) == 'e' || str.getInt(idx) == 'E')) {
      ...
      if (idx < end_idx && (str.getInt(idx) == '-' || str.getInt(idx) == '+'))
        idx++;
    ...
    if (is_float) {
      /*
       * parse as a float using a fast path if available, otherwise call user defined
       * method
       */
      return valIndex(parse_float.__call__(numstr), idx);
    } else {
      /*
       * parse as an int using a fast path if available, otherwise call user defined
       * method
       */
