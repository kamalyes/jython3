...
import org.kamalyes.jython3.util.ChannelFD;
...
public class TimeModule {
  ...
  private static PyNamespace clockInfo(boolean adjustable, String implementation, boolean monotonic,
      double resolution) {
  ...
  private static int item(PyTuple tup, int i) {
    ...
    switch (i) {
      ...
      case 5:
        valid = (0 <= val && val <= 61);
        break; // second 0 - 59 (plus 2 leap seconds)
      case 6:
        valid = (0 <= val && val <= 6);
        break; // weekday 0 - 6
      case 7:
        valid = (0 <= val && val < 367);
        break; // julian day 1 - 366 (or 0)
      case 8:
        valid = (-1 <= val && val <= 1);
