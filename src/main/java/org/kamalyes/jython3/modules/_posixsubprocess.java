...
public class _posixsubprocess {
  ...
  // public static final PyObject fork_exec(PyObject process_args, PyObject
  // executable_list,
  ...
  // PyObject errread, PyObject errwrite, PyObject errpipe_read, PyObject
  // errpipe_write,
  ...
  public static final PyObject fork_exec(PyObject[] args, String[] keywords) {
    ...
    //
    // if (p2cread != m1) {
    // eargp.fileActions.add(SpawnFileAction.dup(FilenoUtil.filenoFrom(p2cread),
    // 0));
    // eargp.fileActions.add(SpawnFileAction.close(FilenoUtil.filenoFrom(p2cwrite)));
    // }
    // if (c2pread != m1) {
    // eargp.fileActions.add(SpawnFileAction.dup(FilenoUtil.filenoFrom(c2pwrite),
    // 1));
    // eargp.fileActions.add(SpawnFileAction.close(FilenoUtil.filenoFrom(c2pread)));
    // }
    // if (errread != m1) {
    // eargp.fileActions.add(SpawnFileAction.dup(FilenoUtil.filenoFrom(errwrite),
    // 2));
