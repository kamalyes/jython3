...
public class PyStatResult extends PyTuple {
  ...
  // Return a Python stat result from a posix layer FileStat object, a bulk Map
  // retrieval of attributes, or AttributeView.
  ...
  // Override pyget, getslice to preserve backwards compatiblity that ints are
  // returned for time elements
  ...
  public PyUnicode __repr__() {
    return (PyUnicode) Py.newUnicode(
        TYPE.fastGetName() + "(" +
            ...
            "st_gid=%r, st_size=%r, st_atime=%r, st_mtime=%r, st_ctime=%r)")
        .__mod__(this);
  }
