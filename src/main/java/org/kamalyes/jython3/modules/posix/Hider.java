...
/**
 * Utility class for hiding PosixModule methods depending on the platform, or
 * whether the
...
class Hider {
  ...
  /**
   * Hide module level functions defined in the PosixModule dict not applicable to
   * this
...
@interface Hide {
   ...
   *                 library isn't native. The default NOT_APPLICABLE means the
