...
@ExposedType(name = "itertools.filterfalse", base = PyObject.class, doc = filterfalse.filterfalse_doc)
public class filterfalse extends PyIterator {
  ...
  public static final String filterfalse_doc = "'filterfalse(function or None, sequence) --> filterfalse object\n\n" +
      "Return those items of sequence for which function(item) is false.\n" +
      "If function is None, return the items that are false.'";

  /**
   * Creates an iterator that returns the items of the iterable for which
   * <code>predicate(item)</code> is <code>false</code>. If <code>predicate</code>
   * is null
