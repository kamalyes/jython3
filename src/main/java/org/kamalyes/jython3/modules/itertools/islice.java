...
public class islice extends PyIterator {
  ...
  /**
   * @see #islice___init__(PyObject, PyObject, PyObject, PyObject) startObj
   *      defaults to 0 and stepObj to 1
   */
  ...
  /**
   * @see #islice___init__(PyObject, PyObject, PyObject, PyObject) stepObj
   *      defaults to 1
   */
   ...
   * @param stepObj
   *                 the number of steps to take between each call to
   *                 <code>next()</code>
   */
