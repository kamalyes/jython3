...
import org.kamalyes.jython3.core.PyRange;
...
public class izip extends PyIterator {
  ...
  /**
   * Create an iterator whose <code>next()</code> method returns a tuple where the
   * i-th element
   * comes from the i-th iterable argument. Continues until the shortest iterable
   * is exhausted.
