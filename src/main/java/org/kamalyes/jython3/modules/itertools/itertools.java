...
public class itertools {
  ...
  public static final String __doc__ = "Functional tools for creating and using iterators.\n\nInfinite iterators:\n" +
      "count([n]) --> n, n+1, n+2, ...\n" +
  ...
  static abstract class ItertoolsIterator extends PyIterator {
    ...
    /**
     * Returns the next element from an iterator. If it raises/throws StopIteration
     * just store
  ...
  /**
   * Iterator base class used by <code>dropwhile()</code> and
   * <code>takewhile</code>.
   */
  static class WhileIterator extends ItertoolsIterator {
    ...
    // flag that indicates if the iterator shoul drop or return arguments "while"
      ...
      while (true) {
        ...
        if (element != null) {
          if (!predicateSatisfied) {
            // the predicate is not satisfied yet (or still satisfied in the case of drop
            // beeing
