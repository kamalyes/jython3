...
import org.kamalyes.jython3.core.BaseSet;
...
import org.kamalyes.jython3.core.PyBytecode;
...
import org.kamalyes.jython3.core.PyFrozenSet;
...
public class marshal implements ClassDictInit {
  ...
  public static class Marshaller extends PyObject implements Traverseproc {
    ...
    public int traverse(Visitproc visit, Object arg) {
      return file != null && file instanceof Traverseproc ? ((Traverseproc) file).traverse(visit, arg) : 0;
    }

    @Override
    public boolean refersDirectlyTo(PyObject ob) {
      return file != null && file instanceof Traverseproc ? ((Traverseproc) file).refersDirectlyTo(ob) : false;
    }
  }
