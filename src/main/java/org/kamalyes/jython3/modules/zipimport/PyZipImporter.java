...
public class PyZipImporter extends PyObject {
  ...
  /**
   * CPython zipimport module is very outdated, it's not yet compliant with
   * PEP-451, the specs are checking the old behaviour
   * this method and a few others that are deprecated a simply implemented to
