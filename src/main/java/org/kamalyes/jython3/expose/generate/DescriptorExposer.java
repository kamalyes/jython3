 ...
 * addMethodGetter or addFieldGetter
 * must be called, and possibly one of addMethodSetter and addFieldSetter if
 * this is a settable
 * descriptor. If this is a deletable descriptor, addMethodDeleter may be
 * called. There is no
...
public class DescriptorExposer extends Exposer {
  ...
  /**
   * Creates an exposer that will work on type and have <code>descrName</code> as
   * its name in
   * the type's dict.
   */
