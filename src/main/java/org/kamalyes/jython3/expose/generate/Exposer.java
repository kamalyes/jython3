...
public abstract class Exposer implements Opcodes, PyTypes {
   ...
   * generate may be
   * active at a time on a single instance of Exposer. The ClassVisitor is assumed
   * to have been
  ...
  class Instantiator {
    ...
    /**
     * Push args onto the stack corresponding to the types passed to the
     * constructor.
     */
   ...
   * inst.getTypes().
   * inst should override pushArgs to put arguments of those types on the stack
   * for the call.
   */
  ...
  /**
   * Calls the static method on onType with the given return type and argument
   * types.
   */
  ...
  /**
   * Starts building a method in the class being generated. Must be followed by a
   * call to
  ...
  /**
   * Turns an object of inputType on the top of the stack into an equivalent Py
   * type. Handles
   * primitives, void, and String. If void, the top item on the stack isn't
   * touched.
   */
