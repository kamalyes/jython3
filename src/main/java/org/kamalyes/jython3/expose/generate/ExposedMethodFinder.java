 ...
 * or ExposedMethod
 * annotation is visited, calls handleResult with the exposer constructed with
...
public abstract class ExposedMethodFinder extends MethodVisitor implements PyTypes, Opcodes {
  ...
  /**
   * @param exposer -
   *                the InstanceMethodExposer built as a result of visiting
   *                ExposeMethod
   */
  ...
  /**
   * @param exposer -
   *                the ClassMethodExposer built as a result of visiting
   *                ExposeClassMethod
   */
  ...
  /**
   * @param exposer -
   *                the FunctionExposer built as a result of visiting
   *                ExposedFunction
   */
