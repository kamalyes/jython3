...
public class Version {
  ...
  private static void loadProperties() {
    ...
    final String versionProperties = "/org.kamalyes.jython3/version.properties";
  ...
  /**
   * Return the current hg version number. May be an empty string on environments
   * that
   * can't determine it.
   */
