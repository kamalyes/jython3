...
import static org.kamalyes.jython3.util.CodegenUtils.p;
import static org.kamalyes.jython3.util.CodegenUtils.sig;
...
public class ProxyMaker extends ProxyCodeHelpers implements ClassConstants, Opcodes {
   ...
   * <code>org.kamalyes.jython3.proxies.(superclassName)</code> with
   * <code>superclass</code> as an
  ...
  public ProxyMaker(String superclassName, Class<?> superclass) {
    this("org.kamalyes.jython3.proxies." + superclassName,
  ...
  /**
   * Creates a proxy class maker that produces classes named
   * <code>proxyClassName</code> that
   * extends <code>superclass</code> and implements the interfaces in
  ...
  public void doJavaCall(Code code, String name, String type,
      String jcallName)
      throws Exception {
    code.invokevirtual("org.kamalyes.jython3/core/PyObject", jcallName, makeSig($pyObj, $objArr));
    code.invokestatic("org.kamalyes.jython3/core/Py", "py2" + name, makeSig(type, $pyObj));
  }

  public void getArgs(Code code, Class<?>[] parameters) throws Exception {
    if (parameters.length == 0) {
      code.getstatic("org.kamalyes.jython3/core/Py", "EmptyObjects", $pyObjArr);
    } else {
      code.iconst(parameters.length);
      code.anewarray("java/lang/Object");

      int array = code.getLocal("[org.kamalyes.jython3/core/PyObject");
      code.astore(array);
      ...
      for (i = 0, local_index = 1; i < parameters.length; i++) {
        ...
        switch (getType(parameters[i])) {
          ...
          case tInteger:
            code.iload(local_index);
            local_index += 1;
            code.invokestatic("org.kamalyes.jython3/core/Py", "newInteger", "(I)" + $pyInteger);
            break;
          case tLong:
            code.lload(local_index);
            local_index += 2;
            code.invokestatic("org.kamalyes.jython3/core/Py", "newInteger", "(J)" + $pyObj);
            break;
          case tFloat:
            code.fload(local_index);
            local_index += 1;
            code.invokestatic("org.kamalyes.jython3/core/Py", "newFloat", "(F)" + $pyFloat);
            break;
          case tDouble:
            code.dload(local_index);
            local_index += 2;
            code.invokestatic("org.kamalyes.jython3/core/Py", "newFloat", "(D)" + $pyFloat);
            break;
          case tCharacter:
            code.iload(local_index);
            local_index += 1;
            code.invokestatic("org.kamalyes.jython3/core/Py", "newString", "(C)" + $pyStr);
            break;
          default:
            code.aload(local_index);
            local_index += 1;
  ...
  public void callMethod(Code code,
    ...
    if (exceptions.length > 0) {
      ...
      jcallName = "_jcallexc";
      instLocal = code.getLocal("org.kamalyes.jython3/core/PyObject");
    ...
    switch (getType(ret)) {
      ...
      default:
        ...
        code.invokestatic("org.kamalyes.jython3/core/Py", "tojava", makeSig($obj, $pyObj, $clss));
    ...
    if (exceptions.length > 0) {
      ...
      if (!throwableFound) {
        ...
        code.invokevirtual("org.kamalyes.jython3/core/PyObject", "_jthrow", makeSig("V", $throwable));
   ...
   * <code>declaringClass</code> is null, the generated method will expect to find
   * an object of
   * the method's name in the Python object and call it. If it isn't null, if an
   * object is found
   * in the Python object, it'll be called. Otherwise the superclass will be
   * called. No checking
   ...
   * @param pyName:               name of the python method to which the java
   *                              method
  ...
  public void addMethod(String name,
    ...
    if (!isAbstract) {
      ...
      code.invokestatic("org.kamalyes.jython3/compiler/ProxyMaker", "findPython",
  ...
  public void addClassDictInit() throws Exception {
    ...
    classfile.addInterface(mapClass(org.kamalyes.jython3.core.ClassDictInit.class));
    ...
    code.invokestatic("org.kamalyes.jython3/core/Py", "java2py", makeSig($pyObj, $obj));
    code.invokevirtual("org.kamalyes.jython3/core/PyObject", "__setitem__", makeSig("V", $str, $pyObj));
    code.return_();
  }
  ...
  public void build() throws Exception {
    ...
    addProxy();
    visitConstructors();
    classfile.addInterface("org.kamalyes.jython3/core/PyProxy");
  ...
  /**
   * Visits all methods declared on the given class and classes in its inheritance
   * hierarchy.
  ...
  /**
   * Called for every method on the proxy's superclass and interfaces that can be
   * overriden by the
   * proxy class. If the proxy wants to perform Python lookup and calling for the
   * method,
   * {@link #addMethod(Method)} should be called. For abstract methods, addMethod
   * must be called.
   */
  ...
  /**
   * Called for every constructor on the proxy's superclass that can be overridden
   * by
   * the proxy class.
   */
  ...
  /**
   * Adds a constructor that calls through to the superclass constructor with the
   * same signature
   * and leaves the returned Code open for more operations. The caller of this
   * method must add a
   * return to the Code.
   */
  ...
  /**
   * Calls __initProxy__ on this class with the given types of parameters, which
   * must be
   * available as arguments to the currently called method in the order of the
   * parameters.
   */
