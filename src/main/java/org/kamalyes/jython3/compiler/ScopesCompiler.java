...
public class ScopesCompiler extends Visitor implements ScopeConstants {
  ...
  public void endScope() throws Exception {
    ...
    // Go into the stack to find a non class containing scope to use making the
    // closure
    // See PEP 227
    int dist = 1;
  ...
  @Override
  public Object visitModule(org.kamalyes.jython3.antlr.ast.Module node)
      throws Exception {
  ...
  public Object visitClassDef(ClassDef node) throws Exception {
    ...
    bod.add(node);
    Assign assign = new Assign(node.getToken(),
        Arrays.<expr>asList(new Name(node.getToken(), "__class__", expr_contextType.Store)), innerName);
    bod.add(assign);
