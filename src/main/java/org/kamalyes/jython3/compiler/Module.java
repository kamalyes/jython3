...
import org.kamalyes.jython3.antlr.ast.Bytes;
import org.kamalyes.jython3.antlr.ast.Num;
import org.kamalyes.jython3.antlr.ast.Str;
import org.kamalyes.jython3.antlr.ast.Suite;
import org.kamalyes.jython3.antlr.base.mod;
import org.kamalyes.jython3.core.CodeBootstrap;
import org.kamalyes.jython3.core.CodeFlag;
import org.kamalyes.jython3.core.CodeLoader;
...
import org.kamalyes.jython3.core.PyFunctionTable;
import org.kamalyes.jython3.core.PyInteger;
import org.kamalyes.jython3.core.PyLong;
import org.kamalyes.jython3.core.PyObject;
import org.kamalyes.jython3.core.PyRunnable;
import org.kamalyes.jython3.core.PyRunnableBootstrap;
...
class PyFloatConstant extends Constant implements ClassConstants, Opcodes {
  ...
  public boolean equals(Object o) {
    if (o instanceof PyFloatConstant) {
      // Ensure hashtable works things like for -0.0 and NaN (see
...
class PyCodeConstant extends Constant implements ClassConstants, Opcodes {
  ...
  PyCodeConstant(mod tree, String name, boolean fast_locals, String className, boolean classBody,
    ...
    if (scope.ac != null) {
      ...
      // TODO: not sure we should be modifying scope.ac in a PyCodeConstant
      // constructor.
    ...
    // TODO::: is fname needed at all, or should we just use "name"?
    this.name = fname;
  ...
  // TODO::: this can probably go away now that we can probably just copy the list.
...
public class Module implements Opcodes, ClassConstants, CompilationContext {
  ...
  public Module(String name, String filename, boolean linenumbers) {
    this(name, filename, linenumbers, org.kamalyes.jython3.core.imp.NO_MTIME);
  }
  ...
  public Module(String name, String filename, boolean linenumbers, long mtime) {
    ...
    this.mtime = mtime;
    classfile = new ClassFile(name, p(PyFunctionTable.class), ACC_SYNCHRONIZED | ACC_PUBLIC, mtime);
  ...
  public Module(String name) {
    this(name, name + ".py", true, org.kamalyes.jython3.core.imp.NO_MTIME);
  }
  ...
  public static void compile(mod node, OutputStream ostream, String name, String filename,
    ...
    compile(node, ostream, name, filename, linenumbers, printResults, cflags,
        org.kamalyes.jython3.core.imp.NO_MTIME);
  }
