...
public class ScopeInfo extends Object implements ScopeConstants {
  ...
  public void dump() { // for debugging
    if (org.kamalyes.jython3.core.Options.verbose < org.kamalyes.jython3.core.Py.DEBUG)
      return;
    for (int i = 0; i < level; i++)
      System.err.print(' ');
    System.err.print(((kind != CLASSSCOPE) ? scope_name
        : "class " +
            scope_name)
        + ": ");
  ...
  // Resolve the names used in the given scope, and mark any freevars used in the
  // up scope
