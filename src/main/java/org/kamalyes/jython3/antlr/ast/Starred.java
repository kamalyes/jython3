...
public class Starred extends expr implements Context {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("value"), new PyUnicode("ctx") };
  ...
  public void Starred___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Starred", args, keywords, new String[] { "value", "ctx", "lineno", "col_offset" }, 2,
        true);
