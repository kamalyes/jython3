...
public class Raise extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("exc"), new PyUnicode("cause") };
  ...
  public void Raise___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Raise", args, keywords, new String[] { "exc", "cause", "lineno", "col_offset" }, 2,
        true);
