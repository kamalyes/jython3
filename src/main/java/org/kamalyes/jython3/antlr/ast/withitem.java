...
public class withitem extends PythonTree {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("context_expr"),
      new PyUnicode("optional_vars") };
  ...
  public void withitem___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("withitem", args, keywords, new String[] { "context_expr", "optional_vars" }, 2, true);
