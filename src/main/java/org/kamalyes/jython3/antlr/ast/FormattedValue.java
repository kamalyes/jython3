...
public class FormattedValue extends expr {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("value"), new PyUnicode("conversion"),
      new PyUnicode("format_spec") };
  ...
  public void FormattedValue___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("FormattedValue", args, keywords,
        new String[] { "value", "conversion", "format_spec", "lineno", "col_offset" }, 3, true);
  ...
  public FormattedValue(Integer ttype, Token token, expr value, Integer conversion, expr format_spec) {
    super(ttype, token);
    this.value = value;
    addChild(value);
    this.conversion = conversion;
