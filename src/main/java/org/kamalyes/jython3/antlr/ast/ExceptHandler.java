...
public class ExceptHandler extends excepthandler {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("type"), new PyUnicode("name"),
      new PyUnicode("body") };
  ...
  public void ExceptHandler___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("ExceptHandler", args, keywords,
        new String[] { "type", "name", "body", "lineno", "col_offset" }, 3, true);
  ...
  public ExceptHandler(Integer ttype, Token token, expr type, String name, java.util.List<stmt> body) {
    super(ttype, token);
    this.type = type;
    addChild(type);
    this.name = name;
