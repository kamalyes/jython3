...
public class ClassDef extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("name"), new PyUnicode("bases"),
      new PyUnicode("keywords"), new PyUnicode("body"), new PyUnicode("decorator_list") };
  ...
  public void ClassDef___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("ClassDef", args, keywords,
        new String[] { "name", "bases", "keywords", "body", "decorator_list", "lineno", "col_offset" }, 5,
        true);
  ...
  public ClassDef(PyObject name, PyObject bases, PyObject keywords, PyObject body, PyObject decorator_list) {
    setName(name);
    setBases(bases);
  ...
  public ClassDef(Token token, String name, java.util.List<expr> bases, java.util.List<keyword> keywords,
  ...
  public ClassDef(Integer ttype, Token token, String name, java.util.List<expr> bases,
      java.util.List<keyword> keywords, java.util.List<stmt> body, java.util.List<expr> decorator_list) {
    super(ttype, token);
    this.name = name;
    this.bases = bases;
    if (bases == null) {
