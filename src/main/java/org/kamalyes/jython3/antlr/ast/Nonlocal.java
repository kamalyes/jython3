...
public class Nonlocal extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("names") };
  ...
  public void Nonlocal___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Nonlocal", args, keywords, new String[] { "names", "lineno", "col_offset" }, 1, true);
