...
public class arg extends PythonTree {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("arg"), new PyUnicode("annotation") };
  ...
  public void arg___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("arg", args, keywords, new String[] { "arg", "annotation" }, 2, true);
