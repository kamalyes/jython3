...
public class Lambda extends expr {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("args"), new PyUnicode("body") };
  ...
  public void Lambda___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Lambda", args, keywords, new String[] { "args", "body", "lineno", "col_offset" }, 2,
        true);
