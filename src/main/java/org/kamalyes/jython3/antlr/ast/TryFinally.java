...
public class TryFinally extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("body"), new PyUnicode("finalbody") };
  ...
  public void TryFinally___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("TryFinally", args, keywords,
        new String[] { "body", "finalbody", "lineno", "col_offset" }, 2, true);
  ...
  public TryFinally(Integer ttype, Token token, java.util.List<stmt> body, java.util.List<stmt> finalbody) {
    super(ttype, token);
    this.body = body;
    if (body == null) {
      this.body = new ArrayList<stmt>();
