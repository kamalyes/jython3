...
public class JoinedStrDerived extends JoinedStr implements Slotted, FinalizablePyObjectDerived, TraverseprocDerived {
  ...
  public JoinedStrDerived(PyType subtype) {
    super(subtype);
