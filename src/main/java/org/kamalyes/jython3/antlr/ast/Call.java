...
public class Call extends expr {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("func"), new PyUnicode("args"),
      new PyUnicode("keywords") };
  ...
  public void Call___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Call", args, keywords,
        new String[] { "func", "args", "keywords", "lineno", "col_offset" }, 3, true);
  ...
  public Call(Token token, expr func, java.util.List<expr> args, java.util.List<keyword> keywords) {
    super(token);
    this.func = func;
    addChild(func);
    this.args = args;
  ...
  public Call(PythonTree tree, expr func, java.util.List<expr> args, java.util.List<keyword> keywords) {
    super(tree);
    this.func = func;
    addChild(func);
    this.args = args;
