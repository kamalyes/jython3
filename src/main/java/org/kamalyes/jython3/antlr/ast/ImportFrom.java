...
public class ImportFrom extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("module"), new PyUnicode("names"),
      new PyUnicode("level") };
  ...
  public void ImportFrom___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("ImportFrom", args, keywords,
        new String[] { "module", "names", "level", "lineno", "col_offset" }, 3, true);
