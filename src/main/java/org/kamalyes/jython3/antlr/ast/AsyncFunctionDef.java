...
public class AsyncFunctionDef extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("name"), new PyUnicode("args"),
      new PyUnicode("body"), new PyUnicode("decorator_list"), new PyUnicode("returns") };
  ...
  public void AsyncFunctionDef___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("AsyncFunctionDef", args, keywords,
        new String[] { "name", "args", "body", "decorator_list", "returns", "lineno", "col_offset" }, 5, true);
  ...
  public AsyncFunctionDef(PythonTree tree, String name, arguments args, java.util.List<stmt> body,
      java.util.List<expr> decorator_list, expr returns) {
    super(tree);
    this.name = name;
    this.args = args;
