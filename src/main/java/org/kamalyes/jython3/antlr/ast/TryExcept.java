...
public class TryExcept extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("body"), new PyUnicode("handlers"),
  ...
  public void TryExcept___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("TryExcept", args, keywords,
        new String[] { "body", "handlers", "orelse", "lineno", "col_offset" }, 3, true);
  ...
  public TryExcept(Token token, java.util.List<stmt> body, java.util.List<excepthandler> handlers,
  ...
  public TryExcept(PythonTree tree, java.util.List<stmt> body, java.util.List<excepthandler> handlers,
      java.util.List<stmt> orelse) {
    super(tree);
    this.body = body;
    if (body == null) {
