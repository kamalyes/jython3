...
public class Tuple extends expr implements Context {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("elts"), new PyUnicode("ctx") };
  ...
  public void Tuple___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Tuple", args, keywords, new String[] { "elts", "ctx", "lineno", "col_offset" }, 2,
        true);
