...
public class Assign extends stmt {
  ...
  private final static PyUnicode[] fields = new PyUnicode[] { new PyUnicode("targets"), new PyUnicode("value") };
  ...
  public void Assign___init__(PyObject[] args, String[] keywords) {
    ArgParser ap = new ArgParser("Assign", args, keywords, new String[] { "targets", "value", "lineno", "col_offset" },
        2, true);
