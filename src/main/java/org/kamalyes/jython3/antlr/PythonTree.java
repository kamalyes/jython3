...
import org.kamalyes.jython3.antlr.ast.VisitorIF;
...
public class PythonTree extends AST implements Traverseproc {
  ...
  public int getCharPositionInLine() {
    ...
    if (token == null || token.getCharPositionInLine() == -1) {
      ...
      // TODO: yucky fix because CPython's ast uses -1 as a real value
  ...
  // TODO::: From here down copied from org.antlr.runtime.tree.BaseTree
